...
# ĐỒNG BỘ CÁC MODULE - CHỈ GIỮ LẠI CÁC DÒNG NÀY
...
from modules.tts import process_all_tts, build_ai_voice_from_srt
...
def process_single_video(
    ...
    try:
        ...
        # 5. Ghép Video, BGM và Voice AI bằng FFmpeg thần tốc
    ...
    # Đã gỡ bỏ cleanup_dir(work_dir) để cơ chế Resume có thể hoạt động nếu bạn chạy lại
    # Bạn có thể bật lại nếu ổ cứng bị đầy
